...
tidy:
	find . -type d -name 'vendor' -prune -o \( -perm /ugo=x -iname '*.md' -o -iname '*php' -o -iname '*.yml' -o -iname '*.xml' -o -iname 'Makefile' -o -iname 'composer.*' -o -iname 'phpunit.xml*' \) -print | xargs chmod -x
